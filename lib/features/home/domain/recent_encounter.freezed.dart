...
@JsonKey(name: 'user_id') String get userId; String get name; String get affiliation;@JsonKey(name: 'icon_url') String get iconUrl;@JsonKey(name: 'met_at') DateTime get metAt;@JsonKey(name: 'event_name') String get eventName;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,name,affiliation,iconUrl,metAt,eventName);

@override
String toString() {
  return 'RecentEncounter(userId: $userId, name: $name, affiliation: $affiliation, iconUrl: $iconUrl, metAt: $metAt, eventName: $eventName)';
}
...
@useResult
$Res call({
@JsonKey(name: 'user_id') String userId, String name, String affiliation,@JsonKey(name: 'icon_url') String iconUrl,@JsonKey(name: 'met_at') DateTime metAt,@JsonKey(name: 'event_name') String eventName
});
...
/// Create a copy of RecentEncounter
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? name = null,Object? affiliation = null,Object? iconUrl = null,Object? metAt = null,Object? eventName = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  String userId,  String name,  String affiliation, @JsonKey(name: 'icon_url')  String iconUrl, @JsonKey(name: 'met_at')  DateTime metAt, @JsonKey(name: 'event_name')  String eventName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecentEncounter() when $default != null:
return $default(_that.userId,_that.name,_that.affiliation,_that.iconUrl,_that.metAt,_that.eventName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  String userId,  String name,  String affiliation, @JsonKey(name: 'icon_url')  String iconUrl, @JsonKey(name: 'met_at')  DateTime metAt, @JsonKey(name: 'event_name')  String eventName)  $default,) {final _that = this;
switch (_that) {
case _RecentEncounter():
return $default(_that.userId,_that.name,_that.affiliation,_that.iconUrl,_that.metAt,_that.eventName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'user_id')  String userId,  String name,  String affiliation, @JsonKey(name: 'icon_url')  String iconUrl, @JsonKey(name: 'met_at')  DateTime metAt, @JsonKey(name: 'event_name')  String eventName)?  $default,) {final _that = this;
switch (_that) {
case _RecentEncounter() when $default != null:
return $default(_that.userId,_that.name,_that.affiliation,_that.iconUrl,_that.metAt,_that.eventName);case _:
  return null;
...
class _RecentEncounter implements RecentEncounter {
  const _RecentEncounter({@JsonKey(name: 'user_id') required this.userId, this.name = '', this.affiliation = '', @JsonKey(name: 'icon_url') this.iconUrl = '', @JsonKey(name: 'met_at') required this.metAt, @JsonKey(name: 'event_name') this.eventName = ''});
...
/// Create a copy of RecentEncounter
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? name = null,Object? affiliation = null,Object? iconUrl = null,Object? metAt = null,Object? eventName = null,}) {
