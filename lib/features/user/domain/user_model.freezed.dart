...
mixin _$UserModel {
 ...
 String get twitterUrl;/// ポートフォリオURL（バックエンド: portfolio_url）
 String get portfolioUrl;/// ConnpassユーザーURL（バックエンド: connpass_url）
...
@override
int get hashCode => Object.hash(runtimeType,id,name,email,iconUrl,oneWord,role,techStack,twitterUrl,portfolioUrl,connpassUrl,affiliation,createdAt,updatedAt);

@override
String toString() {
  return 'UserModel(id: $id, name: $name, email: $email, iconUrl: $iconUrl, oneWord: $oneWord, role: $role, techStack: $techStack, twitterUrl: $twitterUrl, portfolioUrl: $portfolioUrl, connpassUrl: $connpassUrl, affiliation: $affiliation, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, String email, String iconUrl, String oneWord, UserRole role, String techStack, String twitterUrl, String portfolioUrl, String connpassUrl, String affiliation, DateTime? createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String iconUrl,  String oneWord,  UserRole role,  String techStack,  String twitterUrl,  String portfolioUrl,  String connpassUrl,  String affiliation,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.iconUrl,_that.oneWord,_that.role,_that.techStack,_that.twitterUrl,_that.portfolioUrl,_that.connpassUrl,_that.affiliation,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _UserModel implements UserModel {
  const _UserModel({required this.id, required this.name, this.email = '', this.iconUrl = '', this.oneWord = '', this.role = UserRole.other, this.techStack = '', this.twitterUrl = '', this.portfolioUrl = '', this.connpassUrl = '', this.affiliation = '', this.createdAt, this.updatedAt});
